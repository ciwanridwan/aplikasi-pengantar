...
<div class="main">
	...
	<div class="main-content">
		<div class="container-fluid">
			<h3 class="page-title">Input Data Permohonan Pengantar</h3>
				...
				<div class="col-md-12">
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Masukkan Data Permohonan Pengantar</h3>
						</div>
						<div class="panel-body">
							<form method="POST" action="{{ route('store-pengantar')}}">
								@csrf
